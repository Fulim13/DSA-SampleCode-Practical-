...
public class RecordResults extends javax.swing.JFrame {
  ...
  private void jbtConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtConfirmActionPerformed
      ...
      if (finisherList.contains(runner)) {
          JOptionPane.showMessageDialog(null, "The finisher have been recorded", "Duplicate fininsher", JOptionPane.INFORMATION_MESSAGE);
  ...
  private void jtfNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfNumberActionPerformed
      ...
      int index = runnerList.indexOf(new Runner(number));
      if (index == -1) {
          JOptionPane.showMessageDialog(null, "No such runner", "Invalid number", JOptionPane.ERROR_MESSAGE);
          clearFields();
      } else {
          runner = runnerList.get(index);
    ...
    private void initializeList() {
        try {
            ...
            // readObject return javalang , so need to cast it
